...
class DFRobot_SGP40:
    ...
    '''
    def __init__(self,bus = 0,relative_humidity = 50,temperature_c = 25):
        #self.__i2cbus = smbus.SMBus(bus)
        try:
          self.__i2cbus =  I2C(bus)
    ...
    def measure_raw(self):
        ...
        self.__i2cbus.writeto_mem(self.__i2c_addr,self.CMD_MEASURE_RAW_H, [self.CMD_MEASURE_RAW_L,self.__rh_h,self.__rh_l,self.__rh__crc,self.__temc_h,self.__temc_l,self.__temc__crc])
        time.sleep(self.DURATION_READ_RAW_VOC)
        #raw = self.__i2cbus.read_i2c_block_data(self.__i2c_addr,self.OFFSET,3)
        raw = self.__i2cbus.readfrom_mem(self.__i2c_addr,self.OFFSET,3)
    ...
    def __measure_test(self):
        ...
        self.__i2cbus.writeto_mem(self.__i2c_addr,self.CMD_MEASURE_TEST_H, [self.CMD_MEASURE_TEST_L])
        time.sleep(self.DURATION_WAIT_MEASURE_TEST)
        #raw = self.__i2cbus.read_i2c_block_data(self.__i2c_addr,self.OFFSET,2)
        raw = self.__i2cbus.readfrom_mem(self.__i2c_addr,self.OFFSET,2)
    ...
    def __reset(self):
        ...
        self.__i2cbus.writeto_mem(self.__i2c_addr,self.CMD_SOFT__reset_H, [self.CMD_SOFT__reset_L])
    ...
    def __heater_off(self):
        ...
        self.__i2cbus.writeto_mem(self.__i2c_addr,self.CMD_HEATER_OFF_H, [self.CMD_HEATER_OFF_L])
